<template>
  <div class="post" ref="postRef">
    ...
    <div v-if="isDetail===false" @click="goPostDetail(item.id)" class="post-content" style="cursor: pointer;">
      {{ item.content }}
    </div>
    ...
    <el-button-group>
      ...
      <!--  评论  -->
      <el-button v-if="isDetail===false" icon="fas fa-comment-alt" @click="goPostDetail">
        {{ item.comment_count }}
      </el-button>
      <!--  分享  -->
