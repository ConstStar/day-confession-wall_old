  ...
  <div  style="display: flex;align-items: center">
    <el-form :model="addLove" :rules="addLoveRules" ref="addLoveRef" label-width="100px">
      ...
      <el-form-item label="你的名字" prop="CName">
        <el-input v-model="addLove.CName" placeholder="你的名字" style="width: 70%;" @keyup.enter.native="submitForm('addLoveRef')"></el-input>
      </el-form-item>
      <el-form-item label="你的性别" prop="CGender" >
        <el-select v-model="addLove.CGender" placeholder="请选择性别" style="width: 70%;" @keyup.enter.native="submitForm('addLoveRef')">
      ...
      <el-form-item label="TA的名字" prop="BeCName">
        <el-input v-model="addLove.BeCName" placeholder="你的名字" style="width: 70%;" @keyup.enter.native="submitForm('addLoveRef')"></el-input >
      </el-form-item>
      <el-form-item label="TA的性别" prop="BeCGender">
        <el-select v-model="addLove.BeCGender" placeholder="请选择性别" style="width: 70%;" @keyup.enter.native="submitForm('addLoveRef')">
          <el-option label="男" value=1></el-option>
          <el-option label="女" value=2></el-option>
          <el-option label="保密" value=0></el-option>
        </el-select>
      ...
      <el-form-item label="表白内容" prop="CContent">
        <el-input type="textarea" :rows="5" v-model="addLove.CContent" placeholder="不得超过160个字" resize="none" style="width: 300px"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    submitForm(formName) {
      this.$refs[formName].validate( async (valid) => {
        if (valid) {
          const{ data: res } =  await this.$http.post('post',{
